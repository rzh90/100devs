...
3. instructions for what to do now at the start of the remaining string
*/
...
function removeCEekReverse(message) {
    const messageWithoutC = removeC(message)
    const messageWithoutEek = removeEek(messageWithoutC)
    return messageWithoutEek.split("").reverse().join("")
}
