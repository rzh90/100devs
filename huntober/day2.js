/*
1. remove everything up to and including that first 'c'
2. remove all the instances of the word 'Eek!' in the remaining string please (case sensitive, of course)
3. reversed the whole string too. Flip it back around after you've dealt with the 'Eek!'s, if you will
4. instructions for what to do now at the start of the remaining string
    4a. Split this string up on *lowercase* 'V'. The first character in each substring besides this first one is what you need to remember for tomorrow's task.
*/

// 1. remove everything up to and including the first 'c'
function removeC(message) {
    return message.slice(message.indexOf("c") + 1)
}

// 2. remove all the instances of the word 'Eek!'
function removeEek(message) {
    return message.replaceAll("Eek!", "")
}
